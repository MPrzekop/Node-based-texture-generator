...
Shader "Przekop/TextureGraph/ChannelSelect"
{
	Properties
	{
		_MainTex("_MainTex", 2D) = "white" {}
		[KeywordEnum(ALL,RED,GREEN,BLUE,ALPHA)] _Keyword0("Keyword 0", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			#pragma shader_feature_local _KEYWORD0_ALL _KEYWORD0_RED _KEYWORD0_GREEN _KEYWORD0_BLUE _KEYWORD0_ALPHA
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 temp_cast_2 = (tex2DNode1.b).xxxx;
				float4 temp_cast_3 = (tex2DNode1.a).xxxx;
				#if defined(_KEYWORD0_ALL)
				float4 staticSwitch2 = tex2DNode1;
				#elif defined(_KEYWORD0_RED)
				float4 staticSwitch2 = temp_cast_0;
				#elif defined(_KEYWORD0_GREEN)
				float4 staticSwitch2 = temp_cast_1;
				#elif defined(_KEYWORD0_BLUE)
				float4 staticSwitch2 = temp_cast_2;
				#elif defined(_KEYWORD0_ALPHA)
				float4 staticSwitch2 = temp_cast_3;
				#else
				float4 staticSwitch2 = tex2DNode1;
				#endif
...
/*ASEBEGIN
Version=18935
460;228;1119;551;1336.482;340.0387;1.352623;True;False
