...
Shader "Przekop/TextureGraph/Resample"
{
	Properties
	{
...
#endif
				float2 uv_UVMap = i.ase_texcoord1.xy * _UVMap_ST.xy + _UVMap_ST.zw;
				
				
				finalColor = tex2D( _MainTex, ( (tex2D( _UVMap, uv_UVMap )).rg % float2( 1,1 ) ) );
				return finalColor;
			}
			ENDCG
		}
